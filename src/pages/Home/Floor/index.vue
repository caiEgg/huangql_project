    ...
    <div class="floor">
        <div class="py-container">
            <div class="title clearfix">
                ...
                <div class="fr">
                    <ul class="nav-tabs clearfix" ref="refdiv" >
                ...
                <div class="tab-pane">
                    <div class="floor-1">
                        <div class="blockgary">
                            ...
                            <img :src="require(`${floorList.imgUrl}`)" />
                        </div>
                        <div class="floorBanner">
                            <Carsouel :carouselList="floorList.carouselList"></Carsouel>
                        </div>
                        <div class="split">
...
export default {
    ...
    mounted(){
        this.$refs.refdiv.firstChild.className = "active"
