  ...
  <div class="pay-main">
    ...
    <div class="pay-container">
      ...
      <div class="checkout-info">
        <h4>重要说明：</h4>
        <ol>
          <li>欢乐购商城支付平台目前支持<span class="zfb">支付宝</span>支付方式。</li>
      ...
      <div class="checkout-steps">
        ...
        <div class="submit">
          <a class="btn" @click.prevent="pay" >立即支付</a >
        </div>
        <div class="otherpay">
          <div class="step-tit">
            <h5>其他支付方式</h5>
...
import QRCode from 'qrcode'
  export default {
    ...
    methods:{
      ...
      async pay(){
        this.url = await QRCode.toDataURL(this.payInfo.codeUrl)
          this.$alert(`<img src=${this.url} >`, '请使用微信扫码支付', {
